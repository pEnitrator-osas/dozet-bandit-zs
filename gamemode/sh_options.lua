...
local item = GM:AddPointShopWeapon(5,"abakan", ITEMCAT_GUNS, 350, "weapon_zs_abakan")
...
local item = GM:AddPointShopWeapon(4,"rpg_modified", ITEMCAT_GUNS, 429, "weapon_zs_cl_1488")
...
local item = GM:AddPointShopWeapon(3,"piercer", ITEMCAT_MELEE, 185, "weapon_zs_piercer")
GM:AddWeaponPrerequisite(item,"longsword")
local item = GM:AddPointShopWeapon(3,"sucker", ITEMCAT_MELEE, 250, "weapon_zs_sucker")
GM:AddWeaponPrerequisite(item,"bloodseeker")
